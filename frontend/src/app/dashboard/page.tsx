      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-4">
            <div className="whatsapp-gradient p-3 rounded-2xl mr-4">
            ...
            <div className="ghl-gradient p-3 rounded-2xl">
              <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <h1 className="text-5xl font-bold text-white mb-4">
            WhatsApp <span className="whatsapp-gradient bg-clip-text text-transparent">GHL</span> Dashboard
          </h1>
        ...
        {ghlAccount ? (
          <div className="glass rounded-2xl p-6 mb-8">
            <div className="flex items-center">
              <div className="success-gradient p-2 rounded-xl mr-4">
                <svg className="h-6 w-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
            </div>
              <div>
                <h3 className="text-lg font-semibold text-white">GHL Account Connected</h3>
                <p className="text-white/70">Your GoHighLevel account is successfully linked</p>
              </div>
            </div>
          </div>
        ) : (
          <div className="glass rounded-2xl p-6 mb-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <div className="warning-gradient p-2 rounded-xl mr-4">
                  <svg className="h-6 w-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-white">Connect GHL Account</h3>
                  <p className="text-white/70">Link your GoHighLevel account to get started</p>
                </div>
              </div>
              <a
                href="/dashboard/add-subaccount"
                className="ghl-gradient text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105"
              >
                Connect GHL Account
              </a>
          </div>
        ...
        {subaccountStatuses.length > 0 ? (
          <div className="glass rounded-2xl p-6">
            <h2 className="text-2xl font-bold text-white mb-6">Your GHL Locations</h2>
            <div className="grid gap-6">
              {subaccountStatuses.map((subaccount) => (
                <div key={subaccount.id} className="glass rounded-xl p-6 hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      <div className="whatsapp-gradient p-3 rounded-xl">
                      ...
                      <div>
                        ...
                        <p className="text-white/60 text-sm">Location ID: {subaccount.ghl_location_id}</p>
                        {subaccount.phone_number && (
                          <p className="text-green-400 text-sm mt-1 font-medium">📱 {subaccount.phone_number}</p>
                        )}
                      </div>
                    </div>
                    <div className="flex items-center space-x-4">
                      <span className={`px-4 py-2 rounded-xl text-sm font-semibold ${
                        subaccount.status === 'ready' ? 'success-gradient text-white' :
                        subaccount.status === 'qr' ? 'warning-gradient text-white' :
                        subaccount.status === 'initializing' ? 'bg-blue-500 text-white' :
                        subaccount.status === 'disconnected' ? 'error-gradient text-white' :
            ...
            <button
                        ...
                        className="whatsapp-gradient text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105 disabled:opacity-50"
                      >
                        Open QR
            </button>
          </div>
          ...
          <div className="glass rounded-2xl p-8 text-center">
            ...
            <p className="text-white/70">No locations found in your GHL account.</p>
            </div>
          ) : (
          <div className="glass rounded-2xl p-8 text-center">
            ...
            <p className="text-white/70 mb-6">Connect your GoHighLevel account to start using WhatsApp as an SMS provider.</p>
            <a
              href="/dashboard/add-subaccount"
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <p className="text-white/80">Connect your GHL account above</p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="whatsapp-gradient p-2 rounded-lg">
                  <span className="text-white font-bold text-sm">2</span>
                </div>
                <p className="text-white/80">Your locations will appear automatically</p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="whatsapp-gradient p-2 rounded-lg">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <div className="ghl-gradient p-2 rounded-lg">
                  <span className="text-white font-bold text-sm">4</span>
                </div>
                <p className="text-white/80">In GHL Agency, add custom menu link:</p>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <p className="text-white/80">Set as SMS provider in GHL Phone System settings</p>
              </div>
            </div>
          </div>
        </div>
