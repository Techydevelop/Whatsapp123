    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        <div className="flex items-center justify-center mb-6">
          <div className="whatsapp-gradient p-4 rounded-2xl mr-4 shadow-lg">
          ...
          <div className="ghl-gradient p-4 rounded-2xl shadow-lg">
            <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          WhatsApp <span className="whatsapp-gradient bg-clip-text text-transparent">GHL</span> Integration
        </h1>
      ...
      {ghlAccount ? (
        <div className="glass p-6">
          <div className="flex items-center">
            <div className="success-gradient p-3 rounded-xl mr-4 shadow-md">
        ...
        <div className="glass p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className="warning-gradient p-3 rounded-xl mr-4 shadow-md">
                <svg className="h-6 w-6 text-white" fill="currentColor" viewBox="0 0 20 20">
      ...
      {subaccountStatuses.length > 0 ? (
        <div className="glass p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Your GHL Locations</h2>
          <div className="grid gap-4">
            {subaccountStatuses.map((subaccount) => (
              <div key={subaccount.id} className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <div className="whatsapp-gradient p-3 rounded-xl shadow-md">
                      <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893A11.821 11.821 0 0020.885 3.488"/>
                      </svg>
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900">{subaccount.name}</h3>
                      <p className="text-gray-600 text-sm">Location ID: {subaccount.ghl_location_id}</p>
                      {subaccount.phone_number && (
                        <p className="text-green-600 text-sm mt-1 font-medium">📱 {subaccount.phone_number}</p>
                      )}
                    </div>
                  </div>
                  <div className="flex items-center space-x-4">
                    ...
                    <button
                      ...
                      className="whatsapp-gradient text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105 disabled:opacity-50"
                    >
                      Open QR
                    </button>
                  </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <p className="text-gray-700">Connect your GHL account above</p>
            </div>
            <div className="flex items-start space-x-3">
              <div className="whatsapp-gradient p-2 rounded-lg">
                <span className="text-white font-bold text-sm">2</span>
              </div>
              <p className="text-gray-700">Your locations will appear automatically</p>
            </div>
            <div className="flex items-start space-x-3">
              <div className="whatsapp-gradient p-2 rounded-lg">
                <span className="text-white font-bold text-sm">3</span>
              </div>
              <p className="text-gray-700">Click &quot;Open QR&quot; to scan WhatsApp QR code</p>
            </div>
          </div>
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <p className="text-gray-700">In GHL Agency, add custom menu link:</p>
            </div>
            <div className="bg-gray-100 rounded-lg p-3 mt-2">
              <code className="text-green-600 text-sm break-all">
            ...
            <div className="flex items-start space-x-3">
              ...
              <p className="text-gray-700">Set as SMS provider in GHL Phone System settings</p>
            </div>
          </div>
        </div>
      </div>
